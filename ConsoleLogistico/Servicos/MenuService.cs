...
public static class MenuService
{
    ...
    // Pergunta ao usuário se deseja tentar novamente após um erro
    ...
    // Cria uma movimentação de estoque com os parâmetros fornecidos
    ...
    // Tenta aplicar a movimentação de estoque e captura erros
    ...
    // Obtém a quantidade para movimentação do usuário
    ...
    // Executa a calculadora de juros com entrada do usuário
    ...
    // Lê a entrada de data com máscara DD/MM/AAAA
    private static string ReadMaskedDateInput()
    {
        ...
        // Formata a string de dígitos para o formato DD/MM/AAAA
        ...
        // Remove o último dígito da StringBuilder
        static void RemoveLastDigit(StringBuilder digits)
        {
            if (digits.Length > 0)
                digits.Length--;
        }
        // Tenta adicionar um dígito à StringBuilder se for válido
